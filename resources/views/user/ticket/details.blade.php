    ...
    <div data-aos="fade-up" data-aos-duration="1000" class="p-sm-30 p-15 overflow-x-hidden">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap g-10 pb-20">
            ...
            <div class="d-flex flex-wrap g-10">
                <a href="{{route('user.ticket.edit', encrypt($ticketDetails->id))}}" class="py-10 px-26 d-flex align-items-center g-12 fs-15 fw-600 lh-25 text-white bg-main-color bd-one bd-c-main-color bd-ra-8">
                    <div class="d-flex">
                ...
                <button onclick="deleteItem('{{route('user.ticket.delete', encrypt($ticketDetails->id))}}' , 'no','{{route('user.ticket.list')}}')" class="py-10 px-26 d-flex align-items-center g-12 fs-15 fw-600 lh-25 text-red bg-transparent bd-one bd-c-red bd-ra-8">
                    <div class="d-flex">
        ...
        <div class="row justify-content-center rg-20">
                ...
                <div class="bd-one bd-c-stroke bd-ra-10 p-sm-25 p-15 bg-white">
                    ...
                    <div class="">
                        ...
                        <div class="dropdown dropdown-two imageDropdown">
                            <button class="dropdown-toggle border-0 p-0 bg-transparent dropdown-after-hide" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <div class="images">
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="d-flex flex-column rg-15">
                    ...
                    @include('user.ticket.conversation')
                </div>
            </div>
        </div>
    </div>
