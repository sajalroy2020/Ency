            ...
            <div class="col-xl-9">
                ...
                <form class="ajax" action="{{ route('user.profile.update') }}" method="POST"
                    ...
                    <div class="p-sm-25 p-15 bd-one bd-t-zero bd-c-stroke bd-ra-8 bd-tl-ra-0 bd-tr-ra-0 bg-white mb-25">
                        ...
                        <div class="row rg-20 pb-40">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" class="form-control zForm-control" id="editProfileName"
                                       value="{{ auth()->user()->name }}" placeholder="{{ __('First Name') }}" />
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row rg-20 pb-40">
                            <div class="col-md-6">
                                <label for="editProfileName" class="zForm-label">{{ __('Phone Number') }}</label>
                                <input type="text" name="mobile" class="form-control zForm-control" id="editProfileName"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="address" class="form-control zForm-control"
                                       value="{{ auth()->user()->address }}" id="editProfileEmail"
