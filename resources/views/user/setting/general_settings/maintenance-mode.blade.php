                    ...
                    <div class="email-inbox__area bg-style form-horizontal__item bg-style admin-general-settings-page">
                            ...
                            <div class="text-black">
                                ...
                                <li>{{ __("After created maintenance key, you can use this website secretly through this ur") }}
                                    l <span class="iconify"
                                        ...
                                        class="text-primary">{{__('url('/')') }}/{{__('(Your created secret key)')}}</span></li>
                        ...
                        <form class="ajax" action="{{route('admin.setting.maintenance.change')}}" method="POST"
                            ...
                            <div class="justify-content-end row text-end">
                                <div class="col-md-12">
                                    <button type="submit" class="fs-15 fw-500 lh-25 text-black py-10 px-26 bg-cdef84 bd-ra-12 hover-bg-one float-right border-0">{{ __('Update') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
@push('script')
    ...
    <script src="{{ asset('assets/js/maintenance-mode.js') }}"></script>
@endpush
