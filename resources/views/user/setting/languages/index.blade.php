                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="primary-form-group">
                                <div class="primary-form-group-wrap">
                                    <label for="iso_code" class="form-label">{{ __('ISO Code') }}</label>
                                    <select name="iso_code" class="sf-select-without-search">
                                        <option value="">--{{ __('Select ISO Code') }}--</option>
                                        @foreach(languageIsoCode() as $code => $isoCountryName)
                                        <option value="{{$code}}">{{ $isoCountryName.'('.$code.')' }}</option>
                                        @endforeach
                        ...
                        <div class="col-12">
                            <div class="primary-form-group mb-3">
                                <div class="primary-form-group-wrap zImage-upload-details">
                                    ...
                                    <label for="zImageUpload" class="form-label">{{__('Flag')}}</label>
                                    <div class="upload-img-box">
                        ...
                        <div class="col-12">
                            <div class="form-check">
                                ...
                                <div class="zCheck form-check form-switch">
                                    <input class="form-check-input" type="checkbox" value="1" name="default"
                                        role="switch" id="flexCheckChecked" checked />
                                </div>
                            </div>
                        </div>
                    </div>
