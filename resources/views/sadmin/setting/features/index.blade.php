                ...
                <div class="d-flex flex-wrap justify-content-between align-items-center mb-30">
                    ...
                    <div>
                        <button
                            ...
                            <i class="fa fa-plus"></i> {{ __('Add Features') }}
                        </button>
                    </div>
                </div>
                <table class="table zTable zTable-last-item-right" id="featuresDataTable">
                    <thead>
                        <tr>
                            <th>
                                <div>{{ __('Image') }}</div>
...
<div class="modal fade" id="add-modal" aria-hidden="true" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 bd-ra-4 p-25">
            ...
            <form class="ajax reset" action="{{ route('super-admin.setting.features.store') }}" method="post"
...
<input type="hidden" id="features_setting" value="{{ route('super-admin.setting.features.index') }}">
@endsection
@push('script')
<script src="{{ asset('sadmin/custom/js/features_setting.js') }}"></script>
@endpush