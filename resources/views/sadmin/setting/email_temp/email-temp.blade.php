...
<div class="modal fade" id="emailConfigureModal" tabindex="-1" aria-labelledby="emailConfigureModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <form class="ajax" action="{{ route('super-admin.setting.email.template.config.update') }}" method="POST"
                ...
                <div class="modal-footer border-0 pt-0">
                    <button type="submit"
                        class="m-0 fs-15 fw-500 lh-25 py-10 px-26 bg-cdef84 hover-bg-one bg-cdef84 border-0">{{
                        __('Update') }}</button>
                </div>
            </form>
        </div>
