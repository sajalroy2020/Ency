                ...
                <div class="d-flex flex-wrap justify-content-between align-items-center mb-30">
                    ...
                    <div>
                        <button
                            ...
                            <i class="fa fa-plus"></i> {{ __('Add Best Features') }}
                        </button>
                    </div>
                </div>

                <table class="table zTable zTable-last-item-right" id="bestFeaturesDataTable">
                    <thead>
                        <tr>
                            <th>
                                <div>{{ __('Image') }}</div>
...
<input type="hidden" id="core_features_setting" value="{{ route('super-admin.setting.core-features.index') }}">
@endsection
@push('script')
<script src="{{asset('sadmin/custom/js/best_features_setting.js')}}"></script>
@endpush