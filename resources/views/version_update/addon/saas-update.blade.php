...
@section('content')
    <div class="p-30">
        <h4 class="fs-24 fw-500 lh-34 text-black pb-2">{{ __($title) }}</h4>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            ...
                                            <i data-bs-toggle="tooltip" data-bs-placement="top" title="Addon Current Version"
                                                class="fa fa-warning text-danger"></i>
                                            <a href="{{ $codecanyon_url }}" class="link-info">{{ __('Download Addon') }}</a>
                                        @endif
                                    </td>
                                </tr>
                                <tr class="d-none">
                                    ...
                                    <td>
                                        ...
                                        @else
                                            {{ getOption('current_version') }} <i data-bs-toggle="tooltip"
                                                ...
                                                class="fa fa-warning text-danger"></i>
                                            <a href="{{ route(auth()->user()->role == USER_ROLE_SUPER_ADMIN?'super-admin.file-version-update':'admin.file-version-update') }}"
                                ...
                                <tbody class="align-baseline">
                                            ...
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <div class="files" id="previews">
                                                    <div id="template" class="file-upload row">
                                                        <div class="col-md-12">
                                                            <table class="align-middle table table-borderless mb-0">
                                                                <tr>
                                                                    <td>
                                                                    ...
                                                                    <td width="251px">
                                                                        <div id="actions">
                                                                            ...
                                                                            <a data-url="{{ route(auth()->user()->role == USER_ROLE_SUPER_ADMIN?'super-admin.addon.execute':'admin.addon.execute') }}"
                                                        ...
                                                        <div class="bold fw-bold text-center text-success upload-completed">
                                    ...
                                    @if ($uploadedFile != '')
                                        <tr>
                                            <td>
                                                {{ $uploadedFile }}
                                                <a data-url="{{ route(auth()->user()->role == USER_ROLE_SUPER_ADMIN?'super-admin.addon.delete':'admin.addon.delete', $code) }}" data-reload="true"
                                                    class="btn btn-outline-danger ms-2 rounded-3 delete">
    ...
    <div class="modal fade" id="addonUpdateModal" tabindex="-1" aria-labelledby="addonUpdateModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form class="ajax" action="{{ route(auth()->user()->role == USER_ROLE_SUPER_ADMIN?'super-admin.addon.execute':'admin.addon.execute') }}" method="POST"
                    ...
                    <div class="modal-header">
                        ...
                        <button type="button" class="btn-close p-0 top-0 right-10 w-30 h-30 bg-white sf-shadow-one rounded-circle sf-bg-size-10 z-1" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        ...
                        @else
                            <div class="row g-3">
                                <div class="col-md-12">
                                    <div class="alert alert-danger mb-0" type="danger">
                                        <ol class="mb-0">
                                            <li>{{ __('Do not click install button if the application is customised. Your changes will be lost') }}.
                                            </li>
                                        </ol>
                    ...
                    <div class="modal-footer column-gap-2">
...
@push('script')
    ...
    <script>
        ...
        var myDropzone = new Dropzone(document.body, { // Make the whole body a dropzone
            url: "{{ route(auth()->user()->role == USER_ROLE_SUPER_ADMIN?'super-admin.addon.store':'admin.addon.store') }}", // Set the url
            method: 'post',
            headers: {
