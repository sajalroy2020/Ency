            ...
            <div class="col-md-12">
                <div class="p-3 bg-white rounded">
                    <div class="px-20" id="printableArea">
                        ...
                        <div class="d-flex justify-content-between align-items-center pb-50 pt-20">
                            ...
                            <div class="d-flex align-items-center cg-10">
                                @if ($clientInvoice->payment_status == PAYMENT_STATUS_PAID)
                                    <p class="bd-ra-5 py-4 px-14 bg-green-10 fs-12 fw-500 lh-24 text-green">
                                        {{ __('Paid') }}
                                    </p>
                                @elseif ($clientInvoice->payment_status == PAYMENT_STATUS_PENDING)
                                    <p class="bd-ra-5 py-4 px-14 zBadge-pending fs-12 fw-500 lh-24">{{ __('Pending') }}
                                    </p>
                                @elseif ($clientInvoice->payment_status == PAYMENT_STATUS_CANCELLED)
                                    <p class="bd-ra-5 py-4 px-14 zBadge-cancel fs-12 fw-500 lh-24">{{ __('Cancelled') }}
                                    </p>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="pb-30">
                            <h4 class="fs-18 fw-600 lh-28 text-title-black pb-15">
                                {{ __('Invoice
                                                                Items') }}</h4>
                                ...
                                <tbody>
                                    @foreach ($invoiceItem as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ date('j F Y', strtotime($clientInvoice->due_date)) }}</td>
                                            <td>{{ $item->quantity }}</td>
                                ...
                                @if ($clientInvoice->payable_amount > 0)
                                    ...
                                    <li>
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-6">
                                                <p class="fs-14 fw-600 lh-17 text-main-color">
                                                    {{ showPrice($subtotalAmount - $discount - $clientInvoice->payable_amount) }}
                                                </p>
                                            </div>
                                        </div>
                                    </li>
