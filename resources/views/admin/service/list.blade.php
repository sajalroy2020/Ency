...
@section('content')
            ...
            <div
                ...
                <div
                    ...
                    <a href="{{route('admin.services.add-new')}}"
                       class="border-0 bg-main-color py-8 px-26 bd-ra-8 fs-15 fw-600 lh-25 text-white">+ {{__("Add Service")}}</a>
                    <!-- Search -->
            ...
            <div class="p-sm-30 p-15">
                <div class="tab-content" id="myTabContent">
                    @if($pageType != 0 && $pageType == 2)
                        <div class="tab-pane fade " id="serviceGrid-tab-pane" role="tabpanel"
                            ...
                            <div class="row rg-15">
                                <div class="col-md-12 py-30">
                                    {{ $serviceList->appends(['type' => 1])->links('admin.layouts.partial.common_pagination')}}
                                </div>
                            </div>
                            ...
                            <table class="table zTable zTable-last-item-right" id="serviceListTable">
                                ...
                                <tbody>
                                    @foreach($serviceList as $service)
                                        <tr>
                                            <td>
                                                <div class='max-w-120 bd-one bd-c-stroke bd-ra-10 overflow-hidden'><img
                        ...
                        <div class="row rg-15">
                            <div class="col-md-12 py-30">
                                {{ $serviceList->appends(['type' => 2])->links('admin.layouts.partial.common_pagination')}}
                            </div>
                        </div>
                    </div>
                    @else
        ...
        @else
            ...
            <div class="p-sm-30 p-15 bg-white bd-one bd-c-stroke bd-ra-10">
                <div class="create-wrap">
                    ...
                    <a href="{{route('admin.services.add-new')}}"
                       class="d-inline-flex bd-ra-8 bg-main-color py-10 px-26 fs-15 fw-600 lh-25 text-white">+{{__("Add Service")}}</a>
                </div>
            </div>
        </div>
        @endif
    ...
    <input type="hidden" id="serviceSearchRoute" value="{{route('admin.services.search')}}">
@endsection
